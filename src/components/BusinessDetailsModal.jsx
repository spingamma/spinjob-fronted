...
export default function BusinessDetailsModal({ business, onClose, actions, banner }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#1A535C]/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-[#F8F9FA] rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-hidden shadow-2xl flex flex-col">

        {/* Header con gradiente */}
        <div className="bg-gradient-to-r from-[#1A535C] to-[#32698F] p-5 flex justify-between items-center text-white shrink-0">
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6">
          ...
          <div>
            <h3 className="font-bold text-[#F9842C] border-b border-gray-200 pb-2 mb-3">Información Principal</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          {/* Sección 2: Contacto */}
          <div>
            <h3 className="font-bold text-[#F9842C] border-b border-gray-200 pb-2 mb-3">Contacto</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div>
            <h3 className="font-bold text-[#F9842C] border-b border-gray-200 pb-2 mb-3">Redes Sociales</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
