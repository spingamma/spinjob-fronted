            ...
            <div data-testid="filter-container-category" className="flex flex-col gap-1 relative custom-dropdown">
              ...
              <div className="flex gap-2">
                <div 
                  ...
                  `}
                >
                  <LayoutGrid size={14} className={`mr-1 md:mr-2 flex-shrink-0 transition-colors ${openDropdown === 'category' ? 'text-[#F67927]' : 'text-[#32698F]'}`} />
                  ...
                  {activeCategory !== 'Todos' && (
                    <button 
                      ...
                      className="p-1 hover:bg-gray-100 rounded-lg text-gray-400 hover:text-[#F67927] transition-colors ml-1"
                    >
                      <X size={14} />
                    </button>
                  )}
                  <ChevronDown size={11} className={`text-gray-400 ml-0.5 md:ml-1 flex-shrink-0 transition-transform duration-300 ${openDropdown === 'category' ? 'rotate-180 text-[#F67927]' : ''}`} />
                </div>
              </div>
              ...
              {openDropdown === 'category' && (
                <div className="absolute top-full left-0 mt-2 bg-white/95 backdrop-blur-xl border border-gray-100 rounded-2xl shadow-2xl z-50 py-2 w-[260px] md:w-full max-h-80 overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
                  <div className="px-4 py-2 sticky top-0 bg-white/80 backdrop-blur-md z-10 border-b border-gray-50 mb-1">
                    <div className="flex items-center bg-gray-50 border border-gray-200 rounded-lg px-2 py-1.5 focus-within:ring-1 focus-within:ring-[#F67927]/50">
                  ...
                  <button
                    ...
                    className={`w-full text-left px-5 py-3 text-sm font-extrabold transition-colors
                      ${activeCategory === 'Todos' ? 'bg-[#F67927]/10 text-[#F67927]' : 'text-[#F67927] hover:bg-gray-50'}
                    `}
                  >
                    Mostrar todo
                  </button>
                  {filteredGroupedCategories.map(group => (
                    <button
                      ...
                      className={`w-full text-left px-5 py-2.5 text-sm font-bold transition-colors border-t border-gray-50/50
                        ${activeCategory === group.category ? 'text-[#F67927] bg-orange-50/20' : 'text-[#1E3D51] hover:bg-gray-50'}
                      `}
                    >
                      {group.category}
                    </button>
            ...
            {activeCategory !== 'Todos' && (
              <div data-testid="filter-container-subcategory" className="flex flex-col gap-1 relative custom-dropdown animate-in fade-in zoom-in-95 duration-300">
                ...
                <div 
                  ...
                  `}
                >
                  <LayoutList size={14} className={`mr-1 md:mr-2 flex-shrink-0 transition-colors ${openDropdown === 'subcategory' ? 'text-[#F67927]' : 'text-[#32698F]'}`} />
                  <span className="w-full text-left text-xs sm:text-sm text-[#1E3D51] font-extrabold truncate">
                  ...
                  <ChevronDown size={11} className={`text-gray-400 ml-0.5 md:ml-1 flex-shrink-0 transition-transform duration-300 ${openDropdown === 'subcategory' ? 'rotate-180 text-[#F67927]' : ''}`} />
                </div>
                ...
                {openDropdown === 'subcategory' && (
                  <div className="absolute top-full left-0 mt-2 bg-white/95 backdrop-blur-xl border border-gray-100 rounded-2xl shadow-2xl z-50 py-2 w-[260px] md:w-full max-h-80 overflow-y-auto animate-in fade-in zoom-in-95 duration-200">
                    ...
                    <button
                      ...
                      className={`w-full text-left px-5 py-3 text-sm font-extrabold transition-colors
                        ${activeSubcategory === 'Todas' ? 'bg-[#F67927]/10 text-[#F67927]' : 'text-[#F67927] hover:bg-gray-50'}
                      `}
                    >
                    ...
                    {filteredSubcategories.map(sub => (
                      <button
                        ...
                        className={`w-full text-left px-5 py-2.5 text-sm font-medium transition-colors border-t border-gray-50/50
                          ${activeSubcategory === sub ? 'text-[#F67927] bg-orange-50/20 font-bold' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-800'}
                        `}
                      >
                        • {sub}
                      </button>
              ...
              {!isMobile && (
                <>
                  ...
                  <div 
                    ...
                    `}
                  >
                    <MapPin size={14} className={`mr-1 md:mr-2 flex-shrink-0 transition-colors ${openDropdown === 'location' ? 'text-[#F67927]' : 'text-[#32698F]'}`} />
                    <span className="w-full text-left text-xs sm:text-sm text-[#1E3D51] font-extrabold truncate">
                    ...
                    <ChevronDown size={11} className={`text-gray-400 ml-0.5 md:ml-1 flex-shrink-0 transition-transform duration-300 ${openDropdown === 'location' ? 'rotate-180 text-[#F67927]' : ''}`} />
                  </div>
                </>
              )}
              ...
              {openDropdown === 'location' && (
                ...
                `}>
                  ...
                  <button
                    ...
                    className={`w-full text-left px-5 py-3 text-sm font-extrabold transition-colors
                      ${activeState === 'Todas' ? 'bg-[#F67927]/10 text-[#F67927]' : 'text-[#F67927] hover:bg-gray-50'}
                    `}
                  >
                    🌎 Toda Bolivia
                  </button>
                    ...
                    <div key={group.state} className="border-t border-gray-100 my-1 pt-2 pb-1">
                      <button
                        ...
                        className={`w-full text-left px-5 py-2 text-sm font-bold transition-colors
                          ${activeState === group.state && activeNeighborhood === 'Todas' ? 'text-[#F67927] bg-orange-50/50' : 'text-[#1E3D51] hover:bg-gray-50'}
                        `}
                      >
                        📍 {group.state}
                      </button>
                      {group.neighborhoods.map(neigh => (
                        <button
                          ...
                          className={`w-full text-left pl-9 pr-5 py-2 text-sm font-medium transition-colors
                            ${activeNeighborhood === neigh ? 'text-[#F67927] font-bold bg-[#F67927]/5' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-800'}
                          `}
                        >
                          • {neigh}
                        </button>
              ...
              {!isMobile && (
                <>
                  ...
                  <div 
                    ...
                    `}
                  >
                    <Star size={14} className={`mr-1 md:mr-2 flex-shrink-0 transition-colors ${openDropdown === 'rating' ? 'fill-[#F67927] text-[#F67927]' : 'text-[#F67927]'}`} />
                    ...
                    <ChevronDown size={11} className={`text-gray-400 ml-0.5 md:ml-1 flex-shrink-0 transition-transform duration-300 ${openDropdown === 'rating' ? 'rotate-180 text-[#F67927]' : ''}`} />
                  </div>
                </>
              )}
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`w-full text-left px-5 py-3 text-sm font-bold transition-colors
                        ${activeRating === opt.value ? 'bg-[#F67927]/10 text-[#F67927]' : 'text-gray-600 hover:bg-gray-50'}
                      `}
                    >
                      {opt.label}
                    </button>
