  ...
  return (
    <div className="bg-white/70 backdrop-blur-md sticky top-16 md:top-20 z-30 border-b border-gray-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-3 md:py-4">
        ...
        <div className="flex flex-wrap items-center gap-x-3 gap-y-4 md:gap-3">
          
          {/* Active Category Badge */}
          <div
            data-testid="filter-active-category"
            className="flex items-center gap-2 bg-[#1A535C] text-white px-3.5 py-2 rounded-xl shadow-sm transition-all duration-300"
          >
            <LayoutGrid size={14} className="flex-shrink-0 opacity-80" />
            <span className="text-sm font-bold truncate max-w-[180px] md:max-w-none">
              {activeCategory}
            </span>
            <button
          ...
          <div data-testid="filter-container-location" className="relative custom-dropdown">
            ...
            {openDropdown === 'location' && (
              <div className={`absolute top-full mt-2 bg-white/95 backdrop-blur-xl border border-gray-100 rounded-2xl shadow-2xl z-50 py-2 w-[260px] md:w-[280px] max-h-80 overflow-y-auto animate-in fade-in zoom-in-95 duration-200
