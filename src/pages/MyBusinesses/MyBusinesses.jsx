    ...
    <div className="min-h-screen bg-brand-bg font-sans pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 relative">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <Link to="/crear-negocio" onClick={handleNuevoNegocioClick} className="bg-secondary hover:bg-secondary/90 text-white px-4 py-2 rounded-xl font-bold flex items-center gap-2 transition-transform hover:-translate-y-0.5">
