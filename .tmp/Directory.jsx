...
export default function Directory() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] text-[#1E3D51] font-sans pb-28 md:pb-12 antialiased selection:bg-[#1D565F] selection:text-white relative">
      <SeoMeta 
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
        ...
        {cargando ? (
          <div className="text-center py-20 flex flex-col items-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-4 border-[#1D565F] mb-4"></div>
